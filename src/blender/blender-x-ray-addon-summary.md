...
## Comptability (Below are the versions of blender that support the addon. The addon is not tested in other versions of blender (https://github.com/PavelBlend/blender-xray/wiki#supported-blender-versions)):
