...
- [Scripting](tutorials/scripting/README.md)
  - [Introduction to Codebase](tutorials/scripting/codebase-introduction.md)
  - [Codestyle](tutorials/scripting/codestyle.md)
  - [Wetting Our Hands](tutorials/scripting/wetting-hands.md)
  - [Server and Game Objects](tutorials/scripting/server-and-game-objects.md)
  - [Callbacks](tutorials/scripting/callbacks.md)
  - [Time Events](tutorials/scripting/time-events.md)
...
- [Models](tutorials/models/README.md)
  ...
  - [Preparing Building in Blender](tutorials/models/preparing-building-in-blender.md)
  ...
  - [Creating HOM Occluder in Blender](tutorials/models/creating-hom-occluder-in-blender.md)
...
- [File Formats](reference/file-formats/README.md)
  - [Binary Files](reference/file-formats/binary-files.md)
  - [AI File Formats](reference/file-formats/ai/README.md)
    - [*.efd](reference/file-formats/ai/efd.md)
  - [Animations File Formats](reference/file-formats/animations/README.md)
  ...
  - [Achieves | Resources Packs File Formats](reference/file-formats/archives-resource-packs/README.md)
    - [*.db](reference/file-formats/archives-resource-packs/db.md)
    - [*.xr](reference/file-formats/archives-resource-packs/xr.md)
  - [Audio | Video File Formats](reference/file-formats/audio-video/README.md)
    - [*.ogg](reference/file-formats/audio-video/ogg.md)
    - [*.ogm](reference/file-formats/audio-video/ogm.md)
  - [Configs File Formats](reference/file-formats/conf-script/README.md)
  ...
  - [General File Formats](reference/file-formats/general/README.md)
  ...
  - [Models File Formats](reference/file-formats/models/README.md)
  ...
  - [Particles File Formats](reference/file-formats/particles/README.md)
    - [*.pe](reference/file-formats/particles/pe.md)
    - [*.pg](reference/file-formats/particles/pg.md)
  - [Postprocessing File Formats](reference/file-formats/postprocceses/README.md)
    - [*.ppe](reference/file-formats/postprocceses/ppe.md)
  - [Shaders File Formats](reference/file-formats/shaders/README.md)
...
- [Configs](reference/configs/README.md)
  - [Items](reference/configs/items/README.md)
    - [Weapons](reference/configs/items/weapons/README.md)
      - [Weapon World](reference/configs/items/weapons/weapon-world.md)
      - [Weapon HUD](reference/configs/items/weapons/weapon-hud.md)
        - [Weapon HUD Animations](reference/animations/hud-animations-weapons.md)
      - [Weapon Sounds](reference/configs/items/weapons/weapon-sounds.md)
...
- [IX-Ray SDK](modding-tools/sdk/README.md)
  - [Editor Preferences](modding-tools/sdk/editors-preference.md)
  - [Actor Editor](modding-tools/sdk/actor-editor/actor-editor.md)
    - [Item Properties](modding-tools/sdk/actor-editor/windows/item-properties.md)
    - [Bone Form](modding-tools/sdk/actor-editor/windows/bone-parts.md)
    - [Bone Node View](modding-tools/sdk/actor-editor/windows/bones-node-view.md)
    - [Left Bar](modding-tools/sdk/actor-editor/windows/left-bar.md)
    - [Key Form](modding-tools/sdk/actor-editor/windows/key-form.md)
  - [Light Animations Editor](modding-tools/sdk/light-animations-editor/light-animations-editor.md)
  ...
  - [Shader Editor](modding-tools/sdk/shader-editor/shader-editor.md)
    - [Item Properties](modding-tools/sdk/shader-editor/windows/se-item-properties.md)
      ...
      - [EDITOR: selection](modding-tools/sdk/shader-editor/shader-types/editor-selection.md)
      - [EDITOR: wire](modding-tools/sdk/shader-editor/shader-types/editor-wire.md)
      - [INTERNAL: blur](modding-tools/sdk/shader-editor/shader-types/internal-blur.md)
      - [INTERNAL: gray-scale effect](modding-tools/sdk/shader-editor/shader-types/internal-gray-scale-effect.md)
      - [INTERNAL: shadow projecting](modding-tools/sdk/shader-editor/shader-types/internal-shadow-projecting.md)
      - [LEVEL: detail objects](modding-tools/sdk/shader-editor/shader-types/level-detail-objects.md)
      - [LEVEL: diffuse*base.aref](modding-tools/sdk/shader-editor/shader-types/level-diffuse-base-aref.md)
      - [LEVEL: diffuse*base](modding-tools/sdk/shader-editor/shader-types/level-diffuse-base.md)
      - [LEVEL: implicit**detail](modding-tools/sdk/shader-editor/shader-types/level-implicit-detail.md)
      - [LEVEL: lmap*base.aref](modding-tools/sdk/shader-editor/shader-types/level-lmap-base-aref.md)
      - [LEVEL: lmap*base (default)](modding-tools/sdk/shader-editor/shader-types/level-lmap-base-default.md)
      - [LEVEL: lmap*(env^base)](modding-tools/sdk/shader-editor/shader-types/level-lmap-env-base.md)
      - [LEVEL: (lmap+env*const)*base](modding-tools/sdk/shader-editor/shader-types/level-lmap-env-const-base.md)
      - [LEVEL: trees/bushes](modding-tools/sdk/shader-editor/shader-types/level-trees-bushes.md)
      - [MODEL: Default](modding-tools/sdk/shader-editor/shader-types/model-default.md)
  ...
  - [Particle Editor](modding-tools/sdk/particle-editor/particle-editor.md)
    ...
    - [Right Bar Window](modding-tools/sdk/particle-editor/windows/right-bar.md)
      - [Avoid](modding-tools/sdk/particle-editor/windows/actions/avoid.md)
      - [Bounce](modding-tools/sdk/particle-editor/windows/actions/bounce.md)
      - [Copy VertexB](modding-tools/sdk/particle-editor/windows/actions/copy-vertexb.md)
      - [Damping](modding-tools/sdk/particle-editor/windows/actions/damping.md)
      - [Explosion](modding-tools/sdk/particle-editor/windows/actions/explosion.md)
      - [Follow](modding-tools/sdk/particle-editor/windows/actions/follow.md)
      - [Gravitate](modding-tools/sdk/particle-editor/windows/actions/gravitate.md)
      - [Gravity](modding-tools/sdk/particle-editor/windows/actions/gravity.md)
      - [Jet](modding-tools/sdk/particle-editor/windows/actions/jet.md)
      - [Kill Old](modding-tools/sdk/particle-editor/windows/actions/kill-old.md)
      - [Math Velocity](modding-tools/sdk/particle-editor/windows/actions/match-velocity.md)
      - [Move](modding-tools/sdk/particle-editor/windows/actions/move.md)
      - [Orbit Line](modding-tools/sdk/particle-editor/windows/actions/orbit-line.md)
      - [Orbit Point](modding-tools/sdk/particle-editor/windows/actions/orbit-point.md)
      - [Random Accel](modding-tools/sdk/particle-editor/windows/actions/random-accel.md)
      - [Random Displace](modding-tools/sdk/particle-editor/windows/actions/random-displace.md)
      - [Random Velocity](modding-tools/sdk/particle-editor/windows/actions/random-velocity.md)
      - [Restore](modding-tools/sdk/particle-editor/windows/actions/restore.md)
      - [Scatter](modding-tools/sdk/particle-editor/windows/actions/scatter.md)
      - [Sink Velocity](modding-tools/sdk/particle-editor/windows/actions/sink-velocity.md)
      - [Sink](modding-tools/sdk/particle-editor/windows/actions/sink.md)
      - [Source](modding-tools/sdk/particle-editor/windows/actions/source.md)
      - [Speed Limit](modding-tools/sdk/particle-editor/windows/actions/speed-limit.md)
      - [Target Color](modding-tools/sdk/particle-editor/windows/actions/target-color.md)
      - [Target Rotate](modding-tools/sdk/particle-editor/windows/actions/target-rotate.md)
      - [Target Size](modding-tools/sdk/particle-editor/windows/actions/target-size.md)
      - [Target Velocity](modding-tools/sdk/particle-editor/windows/actions/target-velocity.md)
...
- [Blender X-Ray Addon](modding-tools/blender/blender-x-ray-addon-summary.md)
  ...
  - [Panels](modding-tools/blender/addon-panels/README.md)
    - [X-Ray Engine: Action](modding-tools/blender/addon-panels/panel-action.md)
    - [X-Ray Engine: Armature](modding-tools/blender/addon-panels/panel-armature.md)
    - [X-Ray Engine: Bone](modding-tools/blender/addon-panels/panel-bone.md)
    - [X-Ray Engine: Material](modding-tools/blender/addon-panels/panel-material.md)
    - [X-Ray Engine: Mesh](modding-tools/blender/addon-panels/panel-mesh.md)
    - [X-Ray Engine: Object](modding-tools/blender/addon-panels/panel-object.md)
  ...
  - [Operators](modding-tools/blender/addon-operators/README.md)
    ...
    - [Change Motions](modding-tools/blender/addon-operators/operator-change-motions.md)
    ...
    - [Check Material Parameters](modding-tools/blender/addon-operators/operator-check-material-parameters.md)
    ...
    - [Create Bump Nodes](modding-tools/blender/addon-operators/operator-create-bump-nodes.md)
    ...
    - [Select Vertices by Weight Count](modding-tools/blender/addon-operators/operator-select-vertices-by-weights-count.md)
