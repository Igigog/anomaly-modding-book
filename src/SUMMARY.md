...
- [Configs](reference/configs/README.md)
  - [Weapons Parameters]()
    - [Weapon World Configuration Parameters](reference/configs/items/weapons/w_(weapon)-world.md)
    - [Weapon HUD Configuration Parameters](reference/configs/items/weapons/w_(weapon)-hud.md)
      - [Weapon HUD Animations Parameters](reference/animations/hud-animations-weapons.md)
    - [Weapon Sounds Parameters](reference/configs/items/weapons/weapon_sounds.ltx.md)
  - [Ammo Configuration Parameters](reference/configs/items/weapons/weapon_ammo.ltx.md)
  - [Oufits Configuration Parameters](reference/configs/items/outfits/o_(outfit).ltx.md)
