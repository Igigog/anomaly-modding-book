...
There are no classes in Lua. Their support is implemented by exporting them from [C++](../terminology/coding/c++.md) to [Lua](../terminology/coding/lua.md) via [Luabind](../terminology/coding/luabind.md)
