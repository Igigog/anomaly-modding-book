...
The [THM Editor](modding-tools-textures/thm-editor-by-i-love-kfc.md) from i-love-kfc was taken as the basis, finalized and fixed. Allows you to work with [.thm](../../main-folders-and-files/file-formats/index.html#thm) files.
...
> All parameters same as in [THM Editor by i-love-kfc](modding-tools-textures/thm-editor-by-i-love-kfc.md)
