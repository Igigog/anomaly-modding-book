...
- ![alt text](../../images/blender-images-icons/bone-constraint-properties-icons.svg) [Convert Limits to Constraints](../addon-operators/operator-convert-limits-to-constraints.md)
- ![alt text](../../images/blender-images-icons/close-folder.svg) [Remove Limits Constraints](../addon-operators/operator-remove-limits-constraints.md)
