...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponRPG7.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponRPG7.cpp"
#include "stdafx.h"
...
[Header file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponRPG7.h)

[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponRPG7.cpp)
