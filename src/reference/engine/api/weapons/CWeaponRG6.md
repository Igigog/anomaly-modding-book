...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponRG6.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponRG6.cpp"
#include "stdafx.h"
#include "WeaponRG6.h"
#include "entity.h"
...
[Header file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponRG6.h)

[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponRG6.cpp)
