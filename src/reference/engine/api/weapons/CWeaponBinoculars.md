...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponBinoculars.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponBinoculars.cpp"
#include "stdafx.h"
...
[Header file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponBinoculars.h)

[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponBinoculars.cpp)
