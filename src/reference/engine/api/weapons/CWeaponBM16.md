...
Exported LUA class WP_BM16

## Code

### Header

```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/weaponBM16.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/weaponBM16.cpp"
#include "stdafx.h"
...
[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/028ccf5f5189b393396480076b11e40852ba3ecd/src/xrGame/weaponBM16.cpp?at=master#weaponBM16.cpp)
