...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponShotgun.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponShotgun.cpp"
#include "stdafx.h"
...
[Header file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponShotgun.h)

[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponShotgun.cpp)
