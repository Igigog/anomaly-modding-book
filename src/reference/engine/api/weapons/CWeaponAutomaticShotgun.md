...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponAutomaticShotgun.h"
#pragma once
...
```C++,icon=.devicon-cplusplus-plain,filepath="src/xrGame/WeaponAutomaticShotgun.cpp"
#include "stdafx.h"
...
[Header file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponAutomaticShotgun.h)

[Realization file](https://bitbucket.org/anomalymod/xray-monolith/src/master/src/xrGame/WeaponAutomaticShotgun.cpp)
