...
![Image of an icon sheet](../../reference/configs/images/modding_book_icons_1.png)

You can imagine each slot having a coordinate on this grid. Coordinates start a (0, 0).

**File :** `gamedata\textures\ui\icons\my_icon_sheet.dds`

![Image of an icon sheet with coordinates shown](../../reference/configs/images/modding_book_icons_2.png)
...
![Image of an icon sheet with coordinates shown](../../reference/configs/images/modding_book_icons_3.png)
...
![Image of an icon sheet with coordinates shown](../../reference/configs/images/modding_book_icons_4.png)
