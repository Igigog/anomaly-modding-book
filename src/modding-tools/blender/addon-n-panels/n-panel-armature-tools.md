...
- ![alt text](../../../../assets/icons/blender/bone-constraint-properties-icons.svg) [Convert Limits to Constraints](../addon-operators/operator-convert-limits-to-constraints.md)
- ![alt text](../../../../assets/icons/blender/close-folder.svg) [Remove Limits Constraints](../addon-operators/operator-remove-limits-constraints.md)
