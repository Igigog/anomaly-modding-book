...
- ![alt text](../../icons/bone-constraint-properties-icons.svg) [Convert Limits to Constraints](../addon-operators/operator-convert-limits-to-constraints.md)
- ![alt text](../../icons/close-folder.svg) [Remove Limits Constraints](../addon-operators/operator-remove-limits-constraints.md)
